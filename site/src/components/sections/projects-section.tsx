      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/55 md:text-lg">
            ...
            experimentation—ML, data, and polished product surfaces.
          </p>
        </motion.div>
                  ...
                  <div className="flex items-center gap-2 border-b border-white/[0.08] bg-black/40 px-3 py-2.5">
                    ...
                    <div className="ml-2 flex min-w-0 flex-1 items-center gap-2 rounded-md border border-white/[0.06] bg-black/50 px-3 py-1.5 text-[11px] text-white/45">
                      ...
                      <span className="truncate font-mono text-[10px] text-cyan-200/70 sm:text-[11px]">
                        nba-bot-one.vercel.app
                      </span>
                    </div>
                  </div>
                  <div className="relative aspect-[16/10] overflow-hidden">
                    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_20%,rgba(249,115,22,0.35),transparent_55%),radial-gradient(ellipse_at_80%_80%,rgba(34,211,238,0.25),transparent_50%),linear-gradient(180deg,#0c0c10_0%,#050508_100%)]" />
                    ...
                    <div className="relative flex h-full flex-col items-center justify-center p-6 text-center">
                      ...
                      <p className="mt-2 max-w-[14rem] text-xs leading-relaxed text-white/55">
                        Ensemble ML · live slate · graded history
                      </p>
